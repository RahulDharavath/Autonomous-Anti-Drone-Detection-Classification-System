...
# **2. OBJECTIVE:**
* This project address these challenges by providing an **automated, AI-based anti-drone detection system** and generate alerts only when confidence crosses a safe threshold.
